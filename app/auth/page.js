    ...
    <div className="min-h-screen bg-[#0a0a0b] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <form onSubmit={submit} className="card-dark space-y-5">
          <div>
            {/* ✅ FIXED: Added id and htmlFor to associate label with input */}
            <label htmlFor="email" className="block font-mono text-[10px] tracking-[0.2em] uppercase text-[#c9a84c] mb-2">Email</label>
            <input
              id="email"
              name="email"
              type="email"
          ...
          <div>
            {/* ✅ FIXED: Added id and htmlFor to associate label with input */}
            <label htmlFor="password" className="block font-mono text-[10px] tracking-[0.2em] uppercase text-[#c9a84c] mb-2">Password</label>
            <input
              id="password"
              name="password"
              type="password"
