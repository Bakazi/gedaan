    ...
    <div className="min-h-screen bg-[#0a0a0b] text-[#f0e8d4] overflow-x-hidden">
      ...
      <section id="engine" className="py-32 px-6 bg-gradient-to-b from-[#0a0a0b] via-[#0f0f10] to-[#0a0a0b] border-y border-[rgba(201,168,76,0.12)]">
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-5 gap-4">
            {filters.map((f, i) => (
              <div key={i} onMouseMove={handleCardMove} className="card-dark reveal group cursor-default card-electric" style={{ transitionDelay: `${i * 80}ms`, borderTopColor: f.color, borderTopWidth: '3px' }}>
      ...
      <section id="tiers" className="py-32 px-6">
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
            {tiers.map((t, i) => (
              <div key={t.id} onMouseMove={handleCardMove} className={`card-dark flex flex-col reveal relative group ${t.border} ${t.featured ? 'lg:scale-[1.03] !border-2 glow-gold card-electric' : 'card-electric'}`} style={{ transitionDelay: `${i * 80}ms`, background: `linear-gradient(165deg, var(--slate), var(--bg-2))` }}>
      ...
      <section className="py-32 px-6 text-center relative">
        ...
        <div className="max-w-3xl mx-auto reveal relative z-10">
          ...
          <h2 className="font-display font-light text-5xl md:text-7xl leading-[1] mb-8">End the<br/><em className="line-gold">analysis paralysis.</em></h2>
